...
int app_init(platform_ctxt *ctxt, void *user_data)
{
    ...
    ilog("App init");
    data_to_pup data{};
    hashmap_init(&data.hm, mem_global_arena());
    hashmap_init(&data.hm_u64, mem_global_arena());
    hashmap_init(&data.hm_i64, mem_global_arena());
    hashmap_init(&data.hm_u32, mem_global_arena());
    hashmap_init(&data.hm_i32, mem_global_arena());
    hashmap_init(&data.hm_u16, mem_global_arena());
    hashmap_init(&data.hm_i16, mem_global_arena());
    hashmap_init(&data.hm_u8, mem_global_arena());
    hashmap_init(&data.hm_i8, mem_global_arena());
    hashmap_init(&data.hm_no_simp, mem_global_arena());
    hashset_init(&data.hs, mem_global_arena());
    hashset_init(&data.hs_u64, mem_global_arena());
    hashset_init(&data.hs_i64, mem_global_arena());
    hashset_init(&data.hs_u32, mem_global_arena());
    hashset_init(&data.hs_i32, mem_global_arena());
    hashset_init(&data.hs_u16, mem_global_arena());
    hashset_init(&data.hs_i16, mem_global_arena());
    hashset_init(&data.hs_u8, mem_global_arena());
    hashset_init(&data.hs_i8, mem_global_arena());
    hashset_init(&data.hs_no_simp, mem_global_arena());
