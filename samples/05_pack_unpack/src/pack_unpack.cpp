...
int app_init(platform_ctxt *ctxt, app_data *app)
{
    ...
    hashmap_init(&data.hm_u64);
    hashmap_init(&data.hm_i64);
    hashmap_init(&data.hm_u32);
    hashmap_init(&data.hm_i32);
    hashmap_init(&data.hm_u16);
    hashmap_init(&data.hm_i16);
    hashmap_init(&data.hm_u8);
    hashmap_init(&data.hm_i8);
    hashmap_init(&data.hm_no_simp);

    hashset_init(&data.hs);
    hashset_init(&data.hs_u64);
    hashset_init(&data.hs_i64);
    hashset_init(&data.hs_u32);
    hashset_init(&data.hs_i32);
    hashset_init(&data.hs_u16);
    hashset_init(&data.hs_i16);
    hashset_init(&data.hs_u8);
    hashset_init(&data.hs_i8);
    hashset_init(&data.hs_no_simp);
